...
describe('AuditLogService', () => {
  ...
  describe('logAuth', () => {
    ...
    it('should log authentication event with correct category', async () => {
      await service.logAuth(
        authParams.action,
        authParams.userId,
        authParams.userEmail,
        authParams.ipAddress,
        authParams.userAgent,
        authParams.metadata,
      );
  ...
  describe('logDataChange', () => {
    ...
    it('should log data change event with correct category', async () => {
      await service.logDataChange(
        dataChangeParams.action,
        dataChangeParams.userId,
        dataChangeParams.userEmail,
        dataChangeParams.entityType,
        dataChangeParams.entityId,
        dataChangeParams.oldValues,
        dataChangeParams.newValues,
        dataChangeParams.ipAddress,
        dataChangeParams.description,
      );
  ...
  describe('logApiAccess', () => {
    ...
    it('should log API access with INFO severity for 2xx status', async () => {
      await service.logApiAccess(
        apiAccessParams.userId,
        apiAccessParams.userEmail,
        apiAccessParams.apiEndpoint,
        apiAccessParams.httpMethod,
        apiAccessParams.statusCode,
        apiAccessParams.responseTimeMs,
        apiAccessParams.ipAddress,
        apiAccessParams.userAgent,
        apiAccessParams.requestId,
      );
  ...
  describe('logSecurityEvent', () => {
    ...
    it('should log security event with WARNING severity', async () => {
      await service.logSecurityEvent(
        securityParams.action,
        securityParams.userId,
        securityParams.userEmail,
        securityParams.ipAddress,
        securityParams.userAgent,
        securityParams.description,
  ...
  describe('search', () => {
    ...
    beforeEach(() => {
      mockAuditRepo.createQueryBuilder.mockReturnValue(mockQueryBuilder as any);
  ...
  describe('generateReport', () => {
    ...
    beforeEach(() => {
      ...
      mockAuditRepo.createQueryBuilder
        .mockReturnValueOnce(mainQueryBuilder as any)
        .mockReturnValueOnce(categoryQueryBuilder as any)
        .mockReturnValueOnce(actionQueryBuilder as any)
        .mockReturnValueOnce(severityQueryBuilder as any)
        .mockReturnValueOnce(topUsersQueryBuilder as any)
        .mockReturnValueOnce(topEndpointsQueryBuilder as any)
        .mockReturnValueOnce(failedActionsQueryBuilder as any);
    });
