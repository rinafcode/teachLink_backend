...
export class SensitiveOperationsService {
  ...
  private resolveCategoryForAction(action: AuditAction): AuditCategory {
    const categoryMap: Record<AuditAction, AuditCategory> = {
      ...
      // Issue #833 — RBAC role/permission mutations are security-sensitive.
      [AuditAction.RBAC_ROLE_ASSIGNED]: AuditCategory.SECURITY,
      [AuditAction.RBAC_ROLE_REVOKED]: AuditCategory.SECURITY,
      [AuditAction.RBAC_PERMISSION_GRANTED]: AuditCategory.SECURITY,
      [AuditAction.RBAC_PERMISSION_REVOKED]: AuditCategory.SECURITY,
      [AuditAction.RBAC_ROLE_CREATED]: AuditCategory.AUTHORIZATION,
      [AuditAction.RBAC_ROLE_UPDATED]: AuditCategory.AUTHORIZATION,
      [AuditAction.RBAC_ROLE_DELETED]: AuditCategory.AUTHORIZATION,
      [AuditAction.RBAC_PERMISSION_CREATED]: AuditCategory.AUTHORIZATION,
      [AuditAction.RBAC_PERMISSION_UPDATED]: AuditCategory.AUTHORIZATION,
      [AuditAction.RBAC_PERMISSION_DELETED]: AuditCategory.AUTHORIZATION,
