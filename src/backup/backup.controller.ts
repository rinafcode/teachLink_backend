...
export class BackupController {
    constructor(private readonly recoveryTestingService: RecoveryTestingService, private readonly disasterRecoveryService: DisasterRecoveryService, private readonly backupMonitoringService: BackupMonitoringService) { }
    @Post('restore')
    ...
    @Body()
    dto: TriggerRecoveryTestDto): Promise<RecoveryTestResponseDto> {
    ...
    @Param('testId', ParseUUIDPipe)
    testId: string): Promise<RecoveryTestResponseDto> {
