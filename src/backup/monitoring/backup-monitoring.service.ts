...
export class BackupMonitoringService {
    ...
    private readonly recoveryTestRepository: Repository<RecoveryTest>, private readonly metricsService: MetricsCollectionService, private readonly alertingService: AlertingService) {
