...
export class CollaborationPermissionsService {
     ...
     */
    async grantAccess(resourceId: string, userId: string, permission: PermissionLevel = PermissionLevel.WRITE, grantedBy: string = 'system'): Promise<ResourcePermission> {
     ...
     */
    async updatePermission(resourceId: string, userId: string, newPermission: PermissionLevel, updatedBy: string): Promise<ResourcePermission | null> {
        const resource = this.resources.get(resourceId);
        if (!resource) {
            return null;
        }
     ...
     */
    async inviteUser(resourceId: string, inviterId: string, inviteeId: string, permission: PermissionLevel = PermissionLevel.WRITE): Promise<ResourcePermission> {
