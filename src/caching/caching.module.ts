...
@Module({
  ...
  providers: [CachingService, CacheWarmingService, InvalidationService, CacheAnalyticsService, CacheStrategiesService],
  exports: [CachingService, CacheWarmingService, InvalidationService, CacheAnalyticsService, CacheStrategiesService],
})
