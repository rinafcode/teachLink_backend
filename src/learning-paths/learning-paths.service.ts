...
export class LearningPathsService {
    constructor(private readonly skillAssessmentService: SkillAssessmentService, private readonly pathGenerationService: PathGenerationService, private readonly milestoneTrackingService: MilestoneTrackingService) { }
    generateLearningPath(input: unknown) {
