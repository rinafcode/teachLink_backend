...
export class SegmentController {
    ...
    async create(
    @Body()
    createSegmentDto: CreateSegmentDto): Promise<Segment> {
    ...
    id: string, 
    @Body()
    updateSegmentDto: UpdateSegmentDto): Promise<Segment> {
    ...
    id: string, 
    @Body()
    addMembersDto: AddSegmentMembersDto): Promise<{
        message: string;
        addedCount: number;
    }> {
