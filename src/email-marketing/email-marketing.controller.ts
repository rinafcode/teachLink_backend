...
export class EmailMarketingController {
    ...
    async create(
    @Body()
    createCampaignDto: CreateCampaignDto): Promise<Campaign> {
    ...
    id: string, 
    @Body()
    updateCampaignDto: UpdateCampaignDto): Promise<Campaign> {
    ...
    id: string, 
    @Body()
    scheduleDto: ScheduleCampaignDto): Promise<Campaign> {
