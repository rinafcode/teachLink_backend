...
export class AutomationController {
    ...
    async create(
    @Body()
    createAutomationDto: CreateAutomationDto): Promise<AutomationWorkflow> {
    ...
    id: string): Promise<AutomationWorkflow> {
    ...
    id: string, 
    @Body()
    updateAutomationDto: UpdateAutomationDto): Promise<AutomationWorkflow> {
