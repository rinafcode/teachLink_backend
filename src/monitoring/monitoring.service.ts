...
export class MonitoringService {
    ...
    constructor(private readonly analysisService: PerformanceAnalysisService, private readonly optimizationService: OptimizationService, private readonly alertingService: AlertingService) { }
