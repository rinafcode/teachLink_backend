...
export class AddNotificationContentHashIndex1710000000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // 1. Ensure pgcrypto extension exists for SHA256 hashing
    await queryRunner.query('CREATE EXTENSION IF NOT EXISTS pgcrypto;');

    // 2. Add content_hash column
    await queryRunner.query('ALTER TABLE "notifications" ADD COLUMN "content_hash" VARCHAR(64);');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "notifications" DROP COLUMN "content_hash";');
  }
}
