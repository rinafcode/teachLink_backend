...
import { CreatePaymentIntentResult, CreateSubscriptionResult, ProcessRefundResult, } from './interfaces/payment-provider.interface';
...
export class PaymentsController {
    ...
    @Body()
    createPaymentDto: CreatePaymentDto): Promise<CreatePaymentIntentResult> {
    ...
    req: AuthenticatedRequest, 
    @Body()
    createSubscriptionDto: CreateSubscriptionDto): Promise<CreateSubscriptionResult> {
    ...
    async processRefund(
    @Body()
    refundDto: RefundDto): Promise<ProcessRefundResult> {
    ...
    paymentId: string, 
    @Request()
    req: AuthenticatedRequest): Promise<Invoice> {
    ...
    @Request()
    req: AuthenticatedRequest): Promise<Subscription[]> {
