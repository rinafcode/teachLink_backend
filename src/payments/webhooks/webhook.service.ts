...
export class WebhookService {
    ...
    constructor(private readonly paymentsService: PaymentsService, private readonly providerFactory: ProviderFactoryService, private readonly webhookQueueService: WebhookQueueService) { }
    async handleStripeWebhook(payload: Buffer | undefined, signature: string): Promise<{
        received: boolean;
    ...
    async handlePayPalWebhook(payload: Record<string, unknown>, _transmissionId: string, _transmissionTime: string, _transmissionSig: string, _certUrl: string, _authAlgo: string): Promise<{
        received: boolean;
        webhookRetryId?: string;
    }> {
