...
export class MLModelsController {
  ...
  @ApiQuery({
    name: 'status',
    required: false,
    enum: ['draft', 'training', 'trained', 'deployed', 'archived', 'failed'],
  })
  @ApiQuery({
    name: 'type',
    required: false,
  ...
  async getAllModels(
    ...
    return await this.mlModelsService.findAllModels(
      page,
      limit,
      status,
      type,
  ...
  @ApiResponse({
    status: 400,
    description: 'Cannot delete model with active deployments',
  })
  ...
  async trainModel(
    ...
    return await this.mlModelsService.trainModel(id, trainModelDto);
  }
  ...
  async deployModel(
    ...
    return await this.mlModelsService.deployModel(id, deployModelDto);
  }
  ...
  @ApiParam({
    ...
    description: 'Rollback deployment ID',
  })
  @ApiResponse({
    status: 200,
  ...
  async rollbackDeployment(
    ...
    return await this.mlModelsService.rollbackDeployment(
      deploymentId,
  ...
  @ApiResponse({
    status: 200,
    description: 'Model lineage retrieved successfully',
  })
  @ApiResponse({ status: 404, description: 'Model not found' })
