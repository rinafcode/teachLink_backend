...
describe('MLModelsService - Simple Tests', () => {
  ...
  describe('findModelById', () => {
    it('should return model by id', async () => {
      ...
      const result = await service.findModelById('test-model-1');
  ...
  describe('updateModel', () => {
    it('should update model successfully', async () => {
      ...
      const result = await service.updateModel('test-model-1', updateModelDto);
  ...
  describe('deleteModel', () => {
    it('should delete model successfully', async () => {
      ...
      await service.deleteModel('test-model-1');
