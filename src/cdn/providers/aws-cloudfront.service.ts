...
export class AWSCloudFrontService {
    ...
    async getUsageStatistics(_startDate: Date, _endDate: Date): Promise<unknown> {
    ...
    async updateDistributionSettings(_settings: unknown): Promise<void> {
        try {
    ...
    async getFileMetadata(_key: string): Promise<unknown> {
