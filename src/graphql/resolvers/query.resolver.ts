...
export class QueryResolver {
    ...
    id: string, 
    @Context()
    context: unknown): Promise<UserType> {
    ...
    filter?: UserFilterInput): Promise<PaginatedResponse<UserType>> {
    ...
    filter?: CourseFilterInput): Promise<PaginatedResponse<CourseType>> {
    ...
    id: string, 
    @Context()
    context: unknown): Promise<AssessmentType> {
