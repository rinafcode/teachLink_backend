...
export class EnrollmentsService {
  ...
  async create(createEnrollmentDto: CreateEnrollmentDto): Promise<Enrollment> {
    ...
    await this.coursesRepository.increment(
  ...
  async update(
    ...
    const markingAsCompleted =
      !enrollment.completed && updateEnrollmentDto.completed === true;
  ...
  async remove(id: string): Promise<void> {
    ...
    await this.coursesRepository.decrement(
