...
export default registerAs("videoProcessing", () => ({
  ...
  storage: {
    ...
    allowedMimeTypes: (process.env.ALLOWED_MIME_TYPES || "video/mp4,video/webm,video/avi,video/mov,video/mkv").split(
      ",",
    ),
  },
  ...
  ffmpeg: {
    ...
    maxConcurrentJobs: Number.parseInt(process.env.MAX_CONCURRENT_FFMPEG_JOBS || "4"),
  },
  ...
  monitoring: {
    ...
    healthCheckInterval: Number.parseInt(process.env.HEALTH_CHECK_INTERVAL || "30000"), // 30 seconds
