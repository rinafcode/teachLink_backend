...
export class EmailService {
  constructor(
    ...
    private readonly emailProvider: { sendMail: (to: string, subject: string, body: string) => Promise<{ messageId: string }> },
  ) {}
  ...
  async sendTemplateMail(to: string, templateName: string, context: Record<string, any>): Promise<{ messageId: string }> {
