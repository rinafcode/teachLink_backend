...
export class ABTestingReportsService {
    ...
    private variantRepository: Repository<ExperimentVariant>, private statisticalAnalysisService: StatisticalAnalysisService, private automatedDecisionService: AutomatedDecisionService) { }
    /**
     * Generates comprehensive experiment report
     */
    async generateExperimentReport(experimentId: string): Promise<unknown> {
     ...
     */
    private generateSummary(experiment: Experiment, statisticalAnalysis: unknown): unknown {
     ...
     */
    async getDashboardSummary(filters?: ReportFilters): Promise<unknown> {
     ...
     */
    async generatePerformanceComparisonReport(): Promise<unknown> {
     ...
     */
    private async calculateImprovementPercentage(_experimentId: string, _winnerId: string, _controlId: string): Promise<number> {
