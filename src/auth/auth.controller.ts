...
export class AuthController {
    ...
    async refresh(
    @Body()
    refreshTokenDto: RefreshTokenDto): Promise<unknown> {
    ...
    @Body()
    forgotPasswordDto: ForgotPasswordDto): Promise<unknown> {
    ...
    async resetPassword(
    @Body()
    resetPasswordDto: ResetPasswordDto): Promise<unknown> {
    ...
    async verifyEmail(
    @Body()
    verifyEmailDto: VerifyEmailDto): Promise<unknown> {
