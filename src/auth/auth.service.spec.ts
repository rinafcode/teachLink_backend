...
import { createMockRepository, createMockConfigService, createMockEventEmitter, } from 'test/utils/mock-factories';
...
describe('AuthService', () => {
    ...
    let mockTransactionService: jest.Mocked<unknown>;
    ...
    describe('logout', () => {
        ...
        it('should logout user successfully', async () => {
            ...
            expect(mockAuditLogService.logAuth).toHaveBeenCalledWith(AuditAction.LOGOUT, userId, mockUser.email, '127.0.0.1', 'TestAgent', { sessionId });
        });
        ...
        it('should handle logout without IP and user agent', async () => {
            ...
            expect(mockAuditLogService.logAuth).toHaveBeenCalledWith(AuditAction.LOGOUT, userId, mockUser.email, 'unknown', 'unknown', { sessionId });
        });
    });
    ...
    describe('generateRandomToken', () => {
        it('should generate a random token', () => {
            const token1 = (service as unknown).generateRandomToken();
            const token2 = (service as unknown).generateRandomToken();
