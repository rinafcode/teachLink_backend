...
export function loadFeatureFlags(): FeatureFlagsConfig {
    return {
        ...
        ENABLE_SESSION_MANAGEMENT: getBooleanEnv('ENABLE_SESSION_MANAGEMENT', defaultFeatureFlags.ENABLE_SESSION_MANAGEMENT),
        ...
        ENABLE_DATA_WAREHOUSE: getBooleanEnv('ENABLE_DATA_WAREHOUSE', defaultFeatureFlags.ENABLE_DATA_WAREHOUSE),
        ENABLE_COLLABORATION: getBooleanEnv('ENABLE_COLLABORATION', defaultFeatureFlags.ENABLE_COLLABORATION),
        ENABLE_MEDIA_PROCESSING: getBooleanEnv('ENABLE_MEDIA_PROCESSING', defaultFeatureFlags.ENABLE_MEDIA_PROCESSING),
        ...
        ENABLE_RATE_LIMITING: getBooleanEnv('ENABLE_RATE_LIMITING', defaultFeatureFlags.ENABLE_RATE_LIMITING),
        ENABLE_OBSERVABILITY: getBooleanEnv('ENABLE_OBSERVABILITY', defaultFeatureFlags.ENABLE_OBSERVABILITY),
        ENABLE_CACHING: getBooleanEnv('ENABLE_CACHING', defaultFeatureFlags.ENABLE_CACHING),
        ENABLE_FEATURE_FLAGS: getBooleanEnv('ENABLE_FEATURE_FLAGS', defaultFeatureFlags.ENABLE_FEATURE_FLAGS),
        ENABLE_SEARCH: getBooleanEnv('ENABLE_SEARCH', defaultFeatureFlags.ENABLE_SEARCH),
        ENABLE_NOTIFICATIONS: getBooleanEnv('ENABLE_NOTIFICATIONS', defaultFeatureFlags.ENABLE_NOTIFICATIONS),
        ENABLE_EMAIL_MARKETING: getBooleanEnv('ENABLE_EMAIL_MARKETING', defaultFeatureFlags.ENABLE_EMAIL_MARKETING),
        ENABLE_GAMIFICATION: getBooleanEnv('ENABLE_GAMIFICATION', defaultFeatureFlags.ENABLE_GAMIFICATION),
        ENABLE_ASSESSMENT: getBooleanEnv('ENABLE_ASSESSMENT', defaultFeatureFlags.ENABLE_ASSESSMENT),
        ENABLE_LEARNING_PATHS: getBooleanEnv('ENABLE_LEARNING_PATHS', defaultFeatureFlags.ENABLE_LEARNING_PATHS),
        ENABLE_MODERATION: getBooleanEnv('ENABLE_MODERATION', defaultFeatureFlags.ENABLE_MODERATION),
        ENABLE_ORCHESTRATION: getBooleanEnv('ENABLE_ORCHESTRATION', defaultFeatureFlags.ENABLE_ORCHESTRATION),
        ...
        ENABLE_LOCALIZATION: getBooleanEnv('ENABLE_LOCALIZATION', defaultFeatureFlags.ENABLE_LOCALIZATION),
    };
}
/**
...
export function getEnabledModules(flags: FeatureFlagsConfig): string[] {
    ...
    if (flags.ENABLE_TENANCY)
        modules.push('TenancyModule');
    if (flags.ENABLE_CDN)
        modules.push('CDNModule');
    if (flags.ENABLE_LOCALIZATION)
        modules.push('LocalizationModule');
    return modules;
}
/**
