...
export class ConflictResolutionService {
     ...
     */
    private async determineResolutionStrategy(_migration: MigrationConfig): Promise<ConflictResolutionStrategy> {
     ...
     */
    async getResolutionStrategy(_migration: MigrationConfig, _conflictType?: string): Promise<ConflictResolutionStrategy> {
