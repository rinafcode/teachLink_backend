...
export interface MigrationConfig {
    name: string;
    up: (connection: unknown) => Promise<void>;
    down: (connection: unknown) => Promise<void>;
    version: string;
    dependencies?: string[];
}
@Injectable()
export class MigrationService {
    ...
    private migrationRepository: Repository<Migration>, private conflictResolutionService: ConflictResolutionService, private schemaValidationService: SchemaValidationService, private rollbackService: RollbackService, private environmentSyncService: EnvironmentSyncService) { }
    /**
