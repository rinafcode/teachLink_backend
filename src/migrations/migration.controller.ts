...
export class MigrationController {
    ...
    constructor(private migrationService: MigrationService, private rollbackService: RollbackService, private conflictResolutionService: ConflictResolutionService) { }
    @Get()
    async getAllMigrations(): Promise<unknown> {
    ...
    @Post('rollback')
    @HttpCode(HttpStatus.OK)
    async rollbackMigrationsDefault(
    @Res()
    res: Response): Promise<Response> {
    ...
    @Get('conflicts')
    async getMigrationConflicts(): Promise<unknown> {
