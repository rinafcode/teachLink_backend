...
export class DimensionalModelingService {
     ...
     */
    async createStarSchema(name: string, factTable: Omit<FactTable, 'id'>, dimensionTables: Array<Omit<DimensionTable, 'id'>>): Promise<DimensionalModel> {
     ...
     */
    async createSnowflakeSchema(name: string, factTable: Omit<FactTable, 'id'>, dimensionTables: Array<Omit<DimensionTable, 'id'>>, subDimensions: {
        [key: string]: Array<Omit<DimensionTable, 'id'>>;
     ...
     */
    async executeQuery(queryId: string, parameters: {
        [key: string]: unknown;
    } = {}): Promise<unknown[]> {
    ...
    private generateMockResults(query: AnalyticsQuery, _parameters: {
        [key: string]: unknown;
    }): unknown[] {
