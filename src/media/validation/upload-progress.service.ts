...
export class UploadProgressService {
     ...
     */
    async initializeUpload(uploadId: string, fileName: string, fileSize: number): Promise<UploadProgress> {
    ...
    async listActiveUploads(): Promise<UploadProgress[]> {
        try {
            ...
            return uploads.sort((a, b) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime());
        }
        catch (error) {
