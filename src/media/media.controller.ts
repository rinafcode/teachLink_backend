import { Controller, Post, UseInterceptors, UploadedFile, UseGuards, Get, Param, Req, HttpException, HttpStatus, Logger, Body, UnsupportedMediaTypeException, } from '@nestjs/common';
...
import { buildUploadValidationDetails, MEDIA_UPLOAD_INTERCEPTOR_OPTIONS, } from './validation/upload-validation.util';
@ApiTags('Media')
@ApiBearerAuth()
@Controller('media')
