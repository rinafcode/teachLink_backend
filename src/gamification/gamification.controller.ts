...
export class GamificationController {
    constructor(private readonly gamificationService: GamificationService, private readonly pointsService: PointsService, private readonly badgesService: BadgesService, private readonly leaderboardService: LeaderboardService, private readonly challengesService: ChallengesService) { }
    @Get('progress/:userId')
    async getProgress(
    @Param('userId')
    userId: string) {
