...
export class TenantGuard implements CanActivate {
    constructor(private reflector: Reflector, private isolationService: IsolationService) { }
    async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        const tenantId = request.headers['x-tenant-id'] || request.query.tenantId || request.user?.tenantId;
