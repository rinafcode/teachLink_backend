...
export class TenancyController {
    constructor(private readonly tenancyService: TenancyService, private readonly adminService: TenantAdminService, private readonly billingService: TenantBillingService, private readonly customizationService: CustomizationService) { }
    @Post()
    ...
    id: string, 
    @Body()
    updateCustomizationDto: UpdateTenantCustomizationDto) {
