...
@Index(["blockchainTxHash"], { unique: true, where: "blockchain_tx_hash IS NOT NULL" })
export class Certificate {
  ...
  @Column({ type: "varchar", length: 255, name: "blockchain_tx_hash", nullable: true })
  blockchainTxHash: string

  @Column({ type: "varchar", length: 255, name: "blockchain_network", nullable: true })
  ...
  @Column({ type: "varchar", length: 64, name: "certificate_hash", nullable: true })
