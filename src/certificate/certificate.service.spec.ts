...
describe("CertificateService", () => {
  ...
  describe("create", () => {
    ...
    it("should create a certificate successfully", async () => {
      ...
      mockBlockchainService.generateDigitalSignature.mockReturnValue("signature123")
      mockBlockchainService.createCertificateOnBlockchain.mockResolvedValue(mockBlockchainTx)
      ...
      expect(mockBlockchainService.createCertificateOnBlockchain).toHaveBeenCalled()
    ...
    it("should handle blockchain creation failure gracefully", async () => {
      ...
      mockBlockchainService.generateCertificateHash.mockReturnValue("hash123")
      mockBlockchainService.createCertificateOnBlockchain.mockRejectedValue(new Error("Blockchain network error"))
  ...
  describe("findOne", () => {
    ...
    it("should throw NotFoundException when certificate not found", async () => {
      ...
      await expect(service.findOne("123e4567-e89b-12d3-a456-426614174002")).rejects.toThrow(NotFoundException)
    })
  })
  ...
  describe("verify", () => {
    it("should verify a valid certificate", async () => {
      ...
      mockRepository.findOne.mockResolvedValue(mockCertificate)
      mockBlockchainService.verifyCertificateOnBlockchain.mockResolvedValue(mockBlockchainVerification)
  ...
  describe("revoke", () => {
    it("should revoke a certificate successfully", async () => {
      ...
      mockRepository.findOne.mockResolvedValue(mockCertificate)
      mockBlockchainService.revokeCertificateOnBlockchain.mockResolvedValue(mockBlockchainTx)
      ...
      const result = await service.revoke("123e4567-e89b-12d3-a456-426614174002", "Test revocation")

      expect(mockBlockchainService.revokeCertificateOnBlockchain).toHaveBeenCalledWith("0x123abc", "Test revocation")
    ...
    it("should throw BadRequestException for already revoked certificate", async () => {
      ...
      await expect(service.revoke("123e4567-e89b-12d3-a456-426614174002", "Test revocation")).rejects.toThrow(
        BadRequestException,
      )
    })
  })
  ...
  describe("getSkillCertificates", () => {
    it("should return certificates for a specific skill", async () => {
      ...
      const result = await service.getSkillCertificates("123e4567-e89b-12d3-a456-426614174000", "JavaScript")

      expect(mockRepository.createQueryBuilder).toHaveBeenCalledWith("certificate")
