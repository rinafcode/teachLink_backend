...
export class CertificateController {
  ...
  async getSkillCertificates(@Param('recipientId', ParseUUIDPipe) recipientId: string, @Param('skill') skill: string) {
    return this.certificateService.getSkillCertificates(recipientId, skill)
  }

  @Get('organization/:organization')
  async getCertificatesByOrganization(@Param('organization') organization: string) {
  ...
  @Patch(":id")
  async update(@Param('id', ParseUUIDPipe) id: string, updateCertificateDto: UpdateCertificateDto) {
