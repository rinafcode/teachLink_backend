...
describe('AssessmentsService', () => {
    ...
    describe('create', () => {
        ...
        it('should handle array return from save', async () => {
            ...
            mockAssessmentRepo.save.mockResolvedValue(savedArray as unknown);
            const result = await service.create(createData);
            expect(result).toEqual(mockAssessment);
        });
    });
    ...
    describe('submitAssessment', () => {
        ...
        it('should mark as timed out if submitted after duration', async () => {
            ...
            mockAttemptRepo.findOne.mockResolvedValue(oldAttempt as unknown);
            const result = await service.submitAssessment(attemptId, answers);
    ...
    describe('getResults', () => {
        ...
        beforeEach(() => {
            mockAttemptRepo.findOne.mockResolvedValue(mockResults as unknown);
        });
