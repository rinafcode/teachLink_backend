...
export class MessagingService {
    ...
    private readonly messageQueue: Queue, private readonly tracingService: TracingService) { }
    async addMessageToQueue(data: unknown, options?: unknown): Promise<Job<unknown>> {
