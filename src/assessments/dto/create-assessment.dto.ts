...
export class CreateAssessmentDto {
  ...
  @ApiProperty({ example: "Test your knowledge of JavaScript basics", required: false })
  @IsOptional()
  @IsString()
  description?: string
  ...
  @ApiProperty({ example: true, description: "Whether to show correct answers after completion" })
  @IsOptional()
  @IsBoolean()
  showCorrectAnswers?: boolean

  @ApiProperty({ example: true, description: "Whether to allow review of answers" })
  @IsOptional()
  @IsBoolean()
  allowReview?: boolean
