...
export class TransactionExampleService {
    ...
    constructor(private readonly userRepository: Repository<User>, private readonly transactionService: TransactionService, private readonly transactionHelper: TransactionHelperService, private readonly paymentRepository: Repository<Payment>, private readonly invoiceRepository: Repository<Invoice>) { }
    /**
     ...
     */
    async processWithConditionalRollback(userId: string, data: unknown): Promise<unknown> {
    ...
    private get someRecordRepository(): Repository<unknown> {
        return this.userRepository as unknown;
    }
}
