...
describe('FileUploadService', () => {
  ...
  describe('uploadFile', () => {
    ...
    it('should throw BadRequestException for invalid file type', async () => {
      ...
      await expect(
        service.uploadFile(invalidFile, FileCategory.IMAGE, 'user-1'),
    ...
    it('should throw BadRequestException for file too large', async () => {
      ...
      await expect(
        service.uploadFile(largeFile, FileCategory.IMAGE, 'user-1'),
      ).rejects.toThrow(BadRequestException);
    });
    ...
    it('should throw BadRequestException for executable files', async () => {
      ...
      await expect(
        service.uploadFile(executableFile, FileCategory.IMAGE, 'user-1'),
      ).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('getFile', () => {
    it('should return file buffer and mimetype', async () => {
      ...
      expect(fs.readFile).toHaveBeenCalledWith(
        path.join('uploads', 'image', 'test.jpg'),
      );
    });
    ...
    it('should throw NotFoundException if file not found', async () => {
      ...
      await expect(
        service.getFile(FileCategory.IMAGE, 'nonexistent.jpg'),
  ...
  describe('deleteFile', () => {
    ...
    it('should throw NotFoundException if file not found', async () => {
      ...
      await expect(
        service.deleteFile(FileCategory.IMAGE, 'nonexistent.jpg'),
      ).rejects.toThrow(NotFoundException);
    });
  });
