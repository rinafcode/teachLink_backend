...
import { StructuredLog, LogQuery, LogSearchResult, LogLevel, } from '../interfaces/observability.interfaces';
/**
...
export class LogAggregationService {
    ...
    async searchLogs(query: LogQuery): Promise<LogSearchResult> {
        ...
        if (query.correlationId) {
            filteredLogs = filteredLogs.filter((log) => log.context.correlationId === query.correlationId);
        }
        if (query.userId) {
