...
import { LogContext, StructuredLog, LogLevel, ErrorDetails, } from '../interfaces/observability.interfaces';
/**
...
export class StructuredLoggerService implements LoggerService {
    ...
    log(messageOrLevel: string | LogLevel, messageOrMetadata?: string | Record<string, unknown>, metadata?: Record<string, unknown>): void {
        let level: LogLevel;
        let message: string;
    ...
    error(message: string, traceOrError?: string | Error, metadata?: Record<string, unknown>): void {
     ...
     */
    logWithTiming(level: LogLevel, message: string, startTime: Date, metadata?: Record<string, unknown>): void {
     ...
     */
    private writeLog(level: LogLevel, message: string, metadata?: Record<string, unknown>, error?: ErrorDetails): void {
     ...
     * Log business event
     */
    logBusinessEvent(eventName: string, eventData: Record<string, unknown>): void {
