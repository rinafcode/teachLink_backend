...
import { ConditionOperator, FlagValueType, TargetingCondition, TargetingConfig, TargetingRule, UserContext, } from '../interfaces';
@Injectable()
export class TargetingService {
    ...
    private applyOperator(operator: ConditionOperator, attributeValue: unknown, conditionValue?: FlagValueType | FlagValueType[]): boolean {
        switch (operator) {
            case 'exists':
