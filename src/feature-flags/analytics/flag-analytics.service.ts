...
import { ExperimentStats, ExperimentVariantStats, FlagAnalyticsEvent, FlagEvaluationStats, FlagSummary, } from '../interfaces';
...
export class FlagAnalyticsService {
     ...
     */
    trackImpression(experimentId: string, variantKey: string, userId?: string, flagKey?: string): void {
     ...
     */
    trackConversion(experimentId: string, variantKey: string, userId?: string, metadata?: Record<string, unknown>): void {
