...
|------------- | ------------- | -------------|
|[**usersGet**](#usersget) | **GET** /users | Get all users (Admin only)|
|[**usersIdDelete**](#usersiddelete) | **DELETE** /users/{id} | Delete user (Admin only)|
|[**usersIdGet**](#usersidget) | **GET** /users/{id} | Get user by ID|
|[**usersIdPatch**](#usersidpatch) | **PATCH** /users/{id} | Update user|
|[**usersPost**](#userspost) | **POST** /users | Create a new user (Admin only)|
