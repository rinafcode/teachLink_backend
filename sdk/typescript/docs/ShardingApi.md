...
```typescript
import { ShardingApi, Configuration, AutoRebalanceRequest } from './api';
...
const { status, data } = await apiInstance.autoRebalance(autoRebalanceRequest);
```
...
```typescript
import { ShardingApi, Configuration } from './api';
...
const { status, data } = await apiInstance.getMigrationStatus(planId);
```
...
```typescript
import { ShardingApi, Configuration, ManualRebalanceRequest } from './api';
...
const { status, data } = await apiInstance.manualRebalance(manualRebalanceRequest);
```
...
const { status, data } = await apiInstance.rollbackMigration(planId);
```
...
```typescript
import { ShardingApi, Configuration, RouteShardRequest } from './api';
...
const { status, data } = await apiInstance.routeShard(routeShardRequest);
```
...
```typescript
import { ShardingApi, Configuration, StartMigrationRequest } from './api';
...
const { status, data } = await apiInstance.startMigration(startMigrationRequest);
```
