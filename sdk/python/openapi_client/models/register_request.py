...
class RegisterRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["email", "password", "firstName", "lastName", "role"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['student', 'teacher']):
            raise ValueError("must be one of enum values ('student', 'teacher')")
        return value
