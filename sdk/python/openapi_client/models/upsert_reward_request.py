...
class UpsertRewardRequest(BaseModel):
    """
    UpsertRewardRequest
    """ # noqa: E501
    title: StrictStr
    ...
    bonus_points: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="bonusPoints")
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["title", "description", "badgeId", "bonusPoints", "metadata"]
