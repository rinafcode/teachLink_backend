...
for (const sourceFile of sourceFiles) {
  ...
  if (fileModified) {
    ...
    let classValidatorImport = sourceFile.getImportDeclaration(
...
project.saveSync();
console.log(
  `Successfully added ${addedDecoratorsCount.value} validation decorators across ${sourceFiles.length} DTO files.`,
);
